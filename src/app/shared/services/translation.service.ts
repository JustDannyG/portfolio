      ...
      projects: [
        {
          ...
          buttons: [
            { label: 'Live Test', href: 'https://danny-gruchmann.de/el-pollo-loco/index.html', target: '_blank', variant: 'primary' },
        ...
        },
        {
          ...
          buttons: [
            { label: 'Live Test', href: 'https://danny-gruchmann.de/join/index.html', target: '_blank', variant: 'primary' },
      ...
      projects: [
        {
          ...
          image: 'assets/img/my-projects/Bildschirmfoto 2025-12-07 um 11.18.25.png',
          buttons: [
            { label: 'Live-Demo', href: 'https://danny-gruchmann.de/el-pollo-loco/index.html', target: '_blank', variant: 'primary' },
            { label: 'GitHub', href: 'https://github.com/JustDannyG/El-Pollo-Loco', target: '_blank', variant: 'secondary' }
          ]
        },
        {
